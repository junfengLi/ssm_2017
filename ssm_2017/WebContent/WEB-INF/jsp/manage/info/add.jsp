...
<div class="row">
	...
	<table  class="tableForm">
		...
		<tr>
			...
			<td>
			<input type="text" onfocus="this.type='password'" id="password" name="password"
			 placeholder="密码" class="col-xs-12 col-sm-5" autocomplete="off" />
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
			<input type="text" onfocus="this.type='password'" id="password2" name="password2"
			 placeholder="确认密码" class="col-xs-12 col-sm-5" autocomplete="off" />
			</td>
			<td></td>
		</tr>
		</c:if>
		...
		<tr>
			...
			<input type="text" id="mobile" name="mobile" value="${user.mobile }"
			 placeholder="手机" class="col-xs-12 col-sm-5">
			</td>
			<td></td>
		</tr>
		<tr>
