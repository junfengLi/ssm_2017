	...
	<div class="main-container-inner"  id="main-container">
		...
		<div class="sidebar sidebar-fixed" id="sidebar">
			...
			<ul class="nav nav-list">
				<li class="active">
					<a href="#" class="menu-text" onclick="return LoadPage(this,'main-content');" data-url="${ctx }/index/main/load">
				...
				<li>
					<a href="#" class="menu-text" onclick="return LoadPage(this,'main-content');" data-url="${ctx }/index/typography/load">
...
<script type="text/javascript">
	jQuery(function($) {
		LoadMainPage('${ctx }/index/main/load','main-content');
