...
import com.web.commons.shiro.Constants;

/**
 * 
 * ClassName:KickFilter 踢出用户功能V2，该版本处理完，如果已经被踢，将直接结束过滤链
 * 
 *
 * @author   JohnYe
 * @version  
 * @since    
 * @Date	 2015	2015年9月16日		下午1:59:16
 * @version 2.0
 *
 * @see
 */
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if (kickUser) {
	        ...
	        if (session.getAttribute(Constants.SESSION_FORCE_LOGOUT_KEY) != null) {
	            ...
	            param.put(Constants.SESSION_FORCE_LOGOUT_KEY, true);
	            
	            saveRequest(request);
	            String loginUrl = getLoginUrl();
	            WebUtils.issueRedirect(request, response, loginUrl,param);
	            return false;
	        }
        }
